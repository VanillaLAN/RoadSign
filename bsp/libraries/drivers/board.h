 ...
 *
 * STEP 4, according to serial po
 
 rt number to define serial port tx/rx DMA function in the board.h file
...
#define BSP_UART5_TX_PIN       "PB9"
#define BSP_UART5_RX_PIN       "PB8"
